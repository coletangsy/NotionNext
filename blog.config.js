...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Curiosity, and wanna know more', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://www.nicoletangsy.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, Blog, Data, AI', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'What a great day, Why dont we discover more?',
